...
plugins=(brew bundler docker gem git node npm osx rake ruby tmux tmuxinator vi-mode web-search xcode mix-fast zsh-syntax-highlighting zsh-autosuggestions)
